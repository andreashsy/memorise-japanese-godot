...
@onready var hiragana_ref = get_node("CanvasLayer/RefCenterContainer/HiraganaRef")
@onready var katakana_ref = get_node("CanvasLayer/RefCenterContainer/KatakanaRef")
